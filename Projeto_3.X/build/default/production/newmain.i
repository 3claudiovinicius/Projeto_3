...
__attribute__((picinterrupt(("high_priority")))) void samples(void){
 unsigned int n;
...
void main(){
 ...
 while(1){
  for (canal = 0; canal < 2; canal++){
   switch (canal){
    case 0: Config_ADCONS(0b00000001, 0b00001110, 0b10101101);
                break;

    case 1: Config_ADCONS(0b00000101, 0b00001101, 0b10101101);
                break;
   }
